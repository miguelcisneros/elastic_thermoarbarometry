...
data = readtable('input_entrapment_P_calculations.xlsx','ReadRowNames',true);
...
filename = 'output_entrapment_P_calculations.xlsx';
writetable(new_table,'output_entrapment_P_calculations.xlsx');
