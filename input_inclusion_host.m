...
data = readtable('input_inclusion_pressures.xlsx','ReadRowNames',true);
...
filename = 'output_entrapment_results.xlsx';
writetable(new_table,'output_entrapment_results.xlsx');
